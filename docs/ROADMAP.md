...
*Last updated: June 2026. Informed by deep research reports: "State of the Art in LiDAR-Derived Terrain Visualization for Archaeological Prospection: Algorithms, Benchmarks, and Adoption Trends (2018–2025)", "Terrain Analysis Algorithm Specifications", "Algorithm Specifications: LD, ASVF, e4MSTP", "LiDAR Visualization for Archaeology", "Next-Generation LiDAR Relief Visualization: A Comprehensive Strategic Blueprint for v2.0+ Architecture", and "From Visualization to Discovery: A Strategic Roadmap for the LiDAR Relief Plugin v2.0". See `docs/research-papers/Synthesis_Research_Findings_v2.0.md` for the cross-paper synthesis.*
...
|---|---|---|---|---|---|
| SVF noise removal | v1.1 planned | ✓ (4 levels) | ✗ | ✗ | ✗ |
| ASVF | v1.2 planned | ✓ (native) | Limited | ✗ | ✗ |
| VAT composite | v1.1 planned | ✓ | Manual | Manual | Manual |
| e4MSTP | v1.3 planned | ✓ | ✗ | ✗ | ✗ |
...
### v1.1 — Composites, Noise, and Usability
...
### v1.3 — Advanced Composites and ML Integration
*Priority: Medium.*
...
## v2.0 Consolidated Roadmap — From Visualization to Discovery
...
### If You Only Ship Three Things (resource-constrained plan)
